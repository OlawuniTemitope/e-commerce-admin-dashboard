        ...
        <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <ImageUpload
                    value={field.value.map(imgarr=>imgarr.url)}
                    disabled={loading}
                    onChange={(url)=>field.onChange([...field.value,{ url}])}
                    onRemove={(url)=>field.onChange([...field.value.filter(curImage => curImage.url !== url)])}/>
                  </FormControl>
                  <FormMessage /> 
                </FormItem>
              )}
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    ...
                    placeholder="Products name" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
